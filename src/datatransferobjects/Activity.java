...
/**
 * Activity is the abstract base class for all maintenance activities. An
 * Activity object contains all the necessary information for a generic
...
public abstract class Activity {
     ...
     * workspaceNotes is null.
     */
    public Activity(Site site, Typology tipology, String description,
            int interventionTime, boolean interruptible, int week,
            Procedure procedure, String workspaceNotes) {
        this(DEFAULT_ID, site, tipology, description, interventionTime, interruptible,
                week, procedure, workspaceNotes);
    }

    /**
     * Constructs an activity with the specified site, typology, description,
     * interventionTime, interruptible, week, procedure, workspaceNotes. The
     * workspaceNotes associated with this activity will not be significant.
     *
     * @param id the activity id
     * @param site the site where the activity is performed
     * @param tipology the typology of the activity
     ...
     *
     * @throws IllegalArgumentException if week is less then 0 or greater than
     * 52 or if one among site, typology, description, procedure is null.
     *
     */
    public Activity(int id, Site site, Typology tipology, String description,
            int interventionTime, boolean interruptible, int week,
    ...
    /**
     * Returns the hash code for this activity The hash code is computed based
     * on the all attribute of the activity.
     *
    ...
    /**
     * Compares this activity to the specified object. The result is
     * <code>true</code> if and only if the argument is not <code>null</code>
     * and is a <code>Activity</code> object that represents a activity with the
     ...
     * <code>Activity</code> equivalent to this activity, <code>false</code>
     * otherwise
     */
    @Override
