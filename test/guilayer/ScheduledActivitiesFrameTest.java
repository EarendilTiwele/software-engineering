...
public class ScheduledActivitiesFrameTest {
    ...
    /**
     * Test of table updates. 
     * For every week: 
     * - get the scheduled activities for that week sorted by ID
     * - update the week combo box
     * - assert all values are correctly inserted in the table
     */
    @Test
